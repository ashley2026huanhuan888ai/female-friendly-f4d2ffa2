...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "女性友好测评" },
      { name: "description", content: "基于用户观察与 AI 分析的女性友好体验观察平台。不进行法律意义上的事实认定，不进行道德审判。" },
      { property: "og:title", content: "女性友好测评" },
      { name: "twitter:title", content: "女性友好测评" },
      { property: "og:description", content: "基于用户观察与 AI 分析的女性友好体验观察平台。不进行法律意义上的事实认定，不进行道德审判。" },
      { name: "twitter:description", content: "基于用户观察与 AI 分析的女性友好体验观察平台。不进行法律意义上的事实认定，不进行道德审判。" },
